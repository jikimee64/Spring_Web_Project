...
//		System.out.println("============================================================");
	...
	public List<Map<String, Object>> CrawlingGoormEdu() {
		...
		for(int i = 0; i < languagelist.size(); i++) {
			url = "https://edu.goorm.io/category/programming?page=1&sort=newest&classification="+languagelist.get(i); // 크롤링할 url지정
		...
		for (int j = 0; j < element.size(); j++) {
			...
			switch(i) {
			case 0: map.put("lan_seq", 1);
			break;
			case 1: map.put("lan_seq", 2);
			break;
			case 2: map.put("lan_seq",3);
			break;
			case 3: map.put("lan_seq",3);
			break;
			case 4: map.put("lan_seq",4);
			break;
			case 5: map.put("lan_seq",5);
			break;
			case 6: map.put("lan_seq",6);
			break;
			case 7: map.put("lan_seq",7);
			break;
			case 8: map.put("lan_seq",8);
			break;
			case 9: map.put("lan_seq",10);
			break;

...
public class AjaxRestController {
	...
	public List<HashMap<String, Object>> deleteFromMessage(@RequestBody HashMap<String, Object> params,
			Principal principal, Criteria_Board cri_b) {
	...
	// 필터 후 검색 및 리스트에 따른 페이징을 적용시키기 위한 static 변수(카테고리로 받은 데이터와 필터결과의 사이즈를 공유)

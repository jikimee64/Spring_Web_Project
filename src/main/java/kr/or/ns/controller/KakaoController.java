...
public class KakaoController {
	...
	private final static String K_CLIENT_ID = "6777ef8fe09d8a4fc38b827b9c4bf4d1";
	private final static String K_REDIRECT_URI = "http://localhost:8002/member/kakaologin.do";

	public static String getAuthorizationUri(HttpSession session) {
		String kakaoUri = "https://kauth.kakao.com/oauth/authorize?" + "client_id=" + K_CLIENT_ID + "&redirect_uri="
